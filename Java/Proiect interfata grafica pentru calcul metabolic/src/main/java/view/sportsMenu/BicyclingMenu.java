...
public class BicyclingMenu extends GenericMenu {
    private JLabel speedL = new JLabel("Bicycling speed:");
    ...
    public BicyclingMenu() {
        super();
        super.setTitle("Bicycling calories calculator");
        ...
        getCalculate().addActionListener(e -> {
            try {
                ...
                bicycling = new Bicycling(Double.parseDouble(getDistanceTF().getText()), Double.parseDouble(getDurationTF().getText()));
                speedTF.setText((int) bicycling.getSpeedKph() + "");
                getBmrTF().setText(personValues.calc_bmr() + "");
                getExerciseTF().setText(bicycling.mets() + "");
                int c = (int) CaloriesBurnedUtil.determineCalories(personValues.getBmr(), bicycling.mets());
        ...
        getStore().addActionListener(e -> {
            if (done) {
                ...
                try {
                    ...
                    wrHistory.write("-------\n" + dtf.format(now) + "\n" + personValues.toString() + bicycling.toString() +
                            "Calories burned: " + c + "\n-------\n\n");
                    wrHistory.flush();
                    wrHistory.close();
