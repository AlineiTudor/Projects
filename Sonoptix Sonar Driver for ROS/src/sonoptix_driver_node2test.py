...
class SonoptixDriverNode:
    ...
    def build_ping_info(self):
        pingInfo=PingInfo()
        if self.driver.current_config["range"]>=30:
    ...
    def build_ranges(self):
        ...
        bin_distance=self.driver.current_config["range"]/self.rows
    ...
    def build_sonar_image_data(self,frame):
        ...
        for beam in range(sonarImageData.beam_count):
            #taking beam measurements from closest to futhest
    ...
    def get_sonar_frames(self):
        ...
        while not rospy.is_shutdown():
            ...
            #sonar_message=self.build_sonar_message(frame)
